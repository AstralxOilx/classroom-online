...
const formatFullTime = (date: Date) => {
    return `${isToday(date) ? "วันนี้" : isYesterday(date) ? "เมื่อวาน" : format(date, "MMM d, yyyy")} ${format(date, "HH:mm:ss น.")}`
}
...
export const Message = ({
    ...
    if (isCompact) {
        return (
            <div className="flex flex-col gap-2 p-1.5 px-5 hover:bg-secondary/60 group relative">

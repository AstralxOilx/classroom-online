...
const JoinPage = () => {
    ...
    return (
        <>
            <div className="h-full flex flex-col gap-y-8 items-center justify-center bg-background p-8 rounded-lg shadow-md">
                ...
                <div className="flex flex-col gap-y-4 items-center justify-center max-w-md">
                    ...
                    <VerificationInput
                        ...
                        classNames={{
                            ...
                            character: "uppercase h-auto rounded-sm border border-gray-30 flex items-center justify-center text-lg font-medium text-gray-500",
